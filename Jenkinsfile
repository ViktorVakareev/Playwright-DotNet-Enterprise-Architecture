pipeline {
    ...
    parameters {
        ...
        string(name: 'inputTestFilter', defaultValue: '', description: 'NUnit filter (e.g., TestCategory=Smoke). Leave blank to run all tests.')
        ...
        booleanParam(name: 'usePrebuilt', defaultValue: false, description: 'Skip build step (Master branch only)')
